    ...
    return (
      <center id='p8-player'>
        <div style={{ width: '512px' }}>
          ...
          <div className='pico8_el' onClick={((event) => window.Module.pico8Reset())}>
          ...
          <div className='pico8_el' onClick={((event) => window.Module.pico8TogglePaused())}>
        ...
        Pause
          ...
          <div className='pico8_el' onClick={((event) => window.Module.requestFullScreen(true, false))}>
         ...
         Fullscreen
          ...
          <div className='pico8_el' onClick={((event) => window.Module.pico8ToggleSound())}>
